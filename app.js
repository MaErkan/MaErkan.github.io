(() => {
  ...
  const PRAISE = ["بارك الله فيك يا بني.", "ما شاء الله، أحسنتَ.", "وفّقك الله إلى الصواب.", "تبارك الله، إجابة نبيلة.", "زادك الله فهمًا يا فتى.", "فتح الله عليك.", "جزاك الله خيرًا.", "أكرمك الله بهذا الفهم.", "نعم والله، هذا هو المراد.", "نفع الله بك يا بني.", "هداك الله إلى السياق.", "أيّدك الله، أصبتَ.", "طيّب الله بيانك.", "سبحان الله، فكّرتَ تفكير العلماء.", "تولّاك الله، وُفِّقتَ."];
  const RETRY = ["وفّقك الله، حاول مرة أخرى.", "وفّقك الله، تأمل السياق يا بني.", "راجع المثال، سدّدك الله.", "فكّر في دلالة الكلمة، هداك الله.", "اقترب، وفّقك الله، أعد المحاولة.", "انظر إلى الجملة كاملة، وفّقك الله."];
