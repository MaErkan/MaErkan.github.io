(() => {
  ...
  const SCREENS = [
    ...
    { id: "examples", label: "أمثلة الكتاب", phase: "اكتشاف", minutes: 2 },
    { id: "board", label: "انتبه لشرح المعلم", phase: "اكتشاف", minutes: 3 },
  ...
  const WEIGHTS = [
    { big: "نَهْر", small: "نُهَيْر", w: "فُعَيْل" },
    { big: "مَسْجِد", small: "مُسَيْجِد", w: "فُعَيْعِل" },
    { big: "مِفْتَاح", small: "مُفَيْتِيح", w: "فُعَيْعِيل" },
  ];
  const DIMIN = [
    { big: "أَسَد", answer: "أُسَيْد", weight: "فُعَيْل", options: ["أُسَيْد", "أُسُود", "سَيِّد"] },
    { big: "مَسْجِد", answer: "مُسَيْجِد", weight: "فُعَيْعِل", options: ["مُسَيْجِد", "مَسَاجِد", "مُسَيْجِيد"] },
    { big: "عُصْفُور", answer: "عُصَيْفِير", weight: "فُعَيْعِيل", options: ["عُصَيْفِير", "عَصَافِير", "عُصَيْفِر"] },
  ];
  const OBJECTIVES = [
  ...
  const BOOK = [
    { sentence: "قد يبدو بيتي أمام الأبراج صُنَيْدِيقًا، لكنه يمتلئ سعادة وحبورًا.", small: "صُنَيْدِيقًا", big: "صُنْدُوق", purpose: "size", why: "البيت يبدو صغير الحجم أمام الأبراج، فالتصغير هنا لصغر الحجم.", bigOptions: ["صُنْدُوق", "صَدِيق", "فُنْدُق"] },
    { sentence: "قضينا على شاطئ الدوحة سُوَيْعَاتٍ جميلة.", small: "سُوَيْعَاتٍ", big: "سَاعَات", purpose: "few", why: "سُوَيْعَات تدل على عدد قليل من الساعات.", bigOptions: ["سَاعَات", "أَسَابِيع", "سَنَوَات"] },
    { sentence: "يعود الصيادون إلى بيوتهم قُبَيْلَ المغرب.", small: "قُبَيْلَ", big: "قَبْل", purpose: "time", why: "قُبَيْلَ المغرب تعني قرب الزمان من المغرب.", bigOptions: ["قَبْل", "قَبْر", "قَبُول"] },
    { sentence: "يقع سوق واقف قُرَيْبَ كورنيش الدوحة.", small: "قُرَيْبَ", big: "قُرْب", purpose: "place", why: "قُرَيْبَ كورنيش الدوحة تدل على قرب المكان.", bigOptions: ["قُرْب", "قَرِيبُون", "قَرْيَة"] },
    { sentence: "قالت الأم لابنتها: يا بُنَيَّتِي، كوني قوية شجاعة.", small: "بُنَيَّتِي", big: "بِنْت", purpose: "love", why: "يا بُنَيَّتِي أسلوب نداء فيه عطف وتحبب.", bigOptions: ["بِنْت", "بَيْت", "بِنَايَة"] },
    { sentence: "دُوَيْلَةٌ معتدية.", small: "دُوَيْلَةٌ", big: "دَوْلَة", purpose: "scorn", why: "دُوَيْلَة هنا للتحقير من شأن الدولة المعتدية.", bigOptions: ["دَوْلَة", "دَوْرَة", "دَالِيَة"] },
  ];
  const MATCH = [
    { id: "m1", sentence: "هذا مُنَيْزِلٌ جميل.", purpose: "size", why: "مُنَيْزِل تصغير مَنْزِل لصغر الحجم." },
    { id: "m2", sentence: "أكلت تُمَيْرَاتٍ.", purpose: "few", why: "تُمَيْرَات تدل على قلة العدد." },
    { id: "m3", sentence: "تعود الطيور قُبَيْلَ الغروب.", purpose: "time", why: "قُبَيْلَ الغروب قرب زمان." },
    { id: "m4", sentence: "مدينة الشمال بُعَيْدَ الخور.", purpose: "place", why: "بُعَيْدَ الخور تدل على قرب المكان." },
    { id: "m5", sentence: "يا بُنَيَّتِي لا تجزعي.", purpose: "love", why: "يا بُنَيَّتِي للعطف والتحبب." },
    { id: "m6", sentence: "دُوَيْلَةٌ معتدية.", purpose: "scorn", why: "دُوَيْلَةٌ معتدية للتحقير." },
  ];
  const WORKSHEET = [
    { sentence: "في الطريق إلى مكة جُبَيْلٌ وهُضَيْبَةٌ.", small: "جُبَيْلٌ وهُضَيْبَةٌ", purpose: "size", why: "جُبَيْل وهُضَيْبَة لصغر حجم الجبل والهضبة." },
    { sentence: "نصلي الضحى بُعَيْدَ طلوع الشمس.", small: "بُعَيْدَ", purpose: "time", why: "بُعَيْدَ طلوع الشمس قرب زمان من الطلوع." },
    { sentence: "يا بُنَيَّ، حافظ على صلاة الجماعة.", small: "بُنَيَّ", purpose: "love", why: "يا بُنَيَّ نداء للعطف والتحبب." },
    { sentence: "يا رُجَيْلُ، اسلك مسالك الرجال.", small: "رُجَيْلُ", purpose: "scorn", why: "يا رُجَيْلُ للتحقير." },
    { sentence: "تفتحت زُهَيْرَاتٌ في حديقتنا.", small: "زُهَيْرَاتٌ", purpose: "few", why: "زُهَيْرَات تدل على قلة العدد." },
  ];
  const PHOTOS = [
  ...
  const QUIZ = [
    { q: 'الغرض من «سُوَيْعَاتٍ»', a: "few" },
    { q: 'الغرض من «قُبَيْلَ المغرب»', a: "time" },
    { q: 'الغرض من «قُرَيْبَ كورنيش الدوحة»', a: "place" },
    { q: 'الغرض من «يا بُنَيَّتِي»', a: "love" },
    { q: 'الغرض من «صُنَيْدِيقًا»', a: "size" },
  ];
  const CLOSE_LEARN = {
    stem: "ما سنتعلمه في درسنا اليوم",
    answer: "أَغْرَاضُ التَّصْغِيرِ",
  ...
  const TIPS = {
    ...
    goals: "اقرأ الأهداف حرفيًا. ثم اعرض أمثلة الكتاب قبل الشرح.",
    examples: "اقرأ الأمثلة جهرًا دون أسئلة. ثم افتح صفحة الشرح.",
    board: "اشرح على السبورة البيضاء. الطلاب ينظرون إليك بلا رفع أيد. بعد الشرح انتقل للأسئلة.",
  ...
  function recall() {
    ...
    const dimin = !wDone ? "" : `<h3>نُصَغِّرُ: أَسَد — مَسْجِد — عُصْفُور</h3>` + DIMIN.map((d) => {
  ...
  function goals() {
    return `<h2>أهداف الدرس</h2>
      ...
      <p class="muted">تفكير ثنائي: أي هدف يبدو أصعب؟</p>
      ${navRow(nextBtn("أمثلة الكتاب", 'data-act="next"'))}`;
  }

  function examples() {
    return `<h2>أمثلة الكتاب</h2>
      ${tip()}
      <ol class="exlist">${BOOK.map((item, i) =>
        `<li class="quote">${i + 1}. ${mark(item.sentence, item.small)}</li>`
      ).join("")}</ol>
  ...
  function board() {
    return `<div class="boardpage">
      <p class="boardtitle">انتبه لشرح المعلم</p>
      <div class="boardspace"></div>
      ${navRow(nextBtn("أسئلة الأمثلة", 'data-act="next"'))}
    </div>`;
  }
  ...
  function close() {
    return `<h2>أكمل</h2>
      ...
      <div class="card"><p>هِرَّة · المطلوب: صِغَرُ الْحَجْمِ</p>
